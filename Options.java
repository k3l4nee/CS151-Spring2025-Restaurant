...
public class Options {
    ...
    public static void showFullTimeOptions(String response, Scanner sc) {
        ...
        while (true) {
            if (response.equals("1")) {
                Options.showRestaurantAdminOptions(response, sc);
                break;
            } else if (response.equals("2")) {
                Options.showInventoryOptions(response, sc);
                break;
            } else if (response.equals("3")) {
                Options.showEmployeeOptions(response, sc);
                break;
    ...
    public static void showRestaurantAdminOptions(String response, Scanner sc) {

    }

    // inventory options
    public static void showInventoryOptions(String response, Scanner sc) {
